...
void setLowestPathTreeNode(treeNode *tn, treeNode **lowTn, Position *dst, int *lowSum, int pathSum, Board board) {
...
treeNode *findTheCheapestPathEndNode(Board board, treeNode *node, Position *dst) {
	...
	setLowestPathTreeNode(node, &lowTn, dst, &lowestSum, 0, board, '\0');
